        ...
        <section className="relative min-h-screen flex items-center justify-center">
          <div className="md:py-10 grid md:grid-cols-2 gap-18 items-center">
            ...
            >
              ...
              >
                Data Outsource was formed in 2008 from a need for a{" "}
                <span className="text-theme">IT Managed Service</span> tailored
                to large retail franchises.
              </motion.h1>
              ...
              >
                Data Outsource led on to provide Managed services to over 500
      ...
      <motion.div className="pb-10">
        <div className="flex flex-col gap-4 items-center justify-center text-center">
          <motion.h1
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.5 }}
            className="text-2xl md:text-3xl lg:text-4xl max-w-3xl font-bold leading-tight"
          >
            Today <span className="text-theme"> Data Outsource </span>provides
            services to varied range of Industries
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, x: -40 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            from Lawyers to Accountant but also white labelled services to a
            very established IT Reseller network, providing Service Management
            and a suite of Industry leading Cloud based services.
          </motion.p>
        </div>
      </motion.div>
          ...
          <div className="py-10 grid  md:grid-cols-2 gap-12 md:gap-18 items-center">
            ...
            >
              <motion.h1
                ...
                className="text-2xl md:text-3xl lg:text-4xl font-bold leading-tight"
              >
                Data Outsource knows the importance of{" "}
                <span className="text-theme">Cyber Security</span> and places
                this as a priority at the forefront of its technology stack, we
                have every vulnerability covered.
              </motion.h1>
              ...
              >
                Our staff and experts, coming from either Microsoft backgrounds
                or operating their own IT Companies so we not only know how to
                technically support our clients but also we know how to treat
                our clients.
              </motion.p>
              <motion.ul className="grid grid-cols-1 gap-4 md:gap-8 mb-8">
                {bullets.map((bullet, index) => (
                  <motion.li
                    key={index}
                    className="text-sm flex gap-2 items-center"
                  >
                    <BadgeCheck className="w-5 md:w-8  shrink-0" />
                    <span>{bullet}</span>
                  </motion.li>
                ))}
              </motion.ul>
